          ...
          <div className="overflow-hidden rounded-[2rem] bg-[linear-gradient(135deg,#061b2e_0%,#0a2e4d_100%)] p-8 text-contrast shadow-[0_24px_60px_rgba(17,28,45,0.18)] md:p-10">
            ...
            <div className="mt-8 space-y-3">
              {contactPoints.map(({ icon: Icon, value }, idx) => (
                <div key={`${idx}-${value}`} className="flex items-center gap-3 rounded-[1.2rem] bg-white/8 px-4 py-3 backdrop-blur">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <a href={COMPANY.whatsappUrl} className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/5 px-5 py-3 text-sm font-semibold text-contrast backdrop-blur">
                <MessageCircle size={16} />
                WhatsApp
              </a>
            </div>

            <div className="mt-8 rounded-[1.4rem] bg-white/8 p-5 backdrop-blur">
